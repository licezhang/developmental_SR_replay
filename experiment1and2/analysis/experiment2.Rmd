...
## The opportunity for offline replay at rest did not influence replanning in children or adults
...
learning_data <- read_csv("../data/experiment2_norest/preprocessed/learning_data.csv",show_col_types = FALSE)
...
first_stage_test_data <- read_csv("../data/experiment2_norest/preprocessed/first_stage_test.csv",show_col_types = FALSE)
...
ggsave("figures/experiment2_secondstagetest.png", height = 4)
```
...
ggsave("figures/experiment2_firststagetest.png", height = 4)
...
ggplot(means, aes(y=one_trial_revaluation,x=trial_num, color=categorical_age)) +
  ...
  xlab("Trial Number") 
ggsave("figures/experiment2_firststagetest_trial.png", height = 4)
```
...
### Directly comparing rest vs no rest
...
data_rest$second_stage_test_z <- scale_this(data_rest$second_stage_test)
...
ggsave("figures/experiment2_filtered_secondstagetest.png")
```
