...
reval_mod_first_choice_only <- glmer(one_trial_revaluation ~  age_z * block_condition + (1 | subject_id),
                  data= first_stage_test_data_trial0,
                  family = binomial,
                  contrasts = list(block_condition="contr.sum"))
my_tab_model(reval_mod_first_choice_only)
