...
learning_data_by_stage <- read_csv("../data/experiment2_norest/preprocessed/learning_data_by_stage.csv",show_col_types = FALSE)
...
ggsave("figures/experiment2_secondstagetest.png")
```
